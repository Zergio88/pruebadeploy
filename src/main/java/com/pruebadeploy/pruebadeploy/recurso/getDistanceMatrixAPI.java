...
public class getDistanceMatrixAPI {
	...
	private static final String API_KEY="AIzaSyAZXwHEMaYaB_NjWkS5qCwPHtIexc9IBv0";
	public static float[][] distancia;
	
	public static String getData(String origen, String destino) throws IOException, InterruptedException {
	
		/*String url="https://maps.googleapis.com/maps/api/distancematrix/json?destinations=-34.6173505163973,-58.38178810357908&origins=-34.61679872494791,-58.52067584629976&key=AIzaSyAZXwHEMaYaB_NjWkS5qCwPHtIexc9IBv0"; */
		...
		String distancia = json.get("rows").get("elements").get("distance").get("text").asText(); */
